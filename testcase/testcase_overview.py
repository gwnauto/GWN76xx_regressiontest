...
class TestOverView(unittest.TestCase):
    ...
    def test_001_factory_reset_setupwizard(self):
        ...
        result2 = tmp1.complete(data_wireless['all_ssid'],data_wireless['short_wpa'],data_basic['wlan_pc'],
                                data_ap["slave:mac1"],data_ap["slave:mac2"])
    ...
    def test_002_AP_status(self):
        ...
        assert (result1 == "3") and (result2 == ['0','3']),"check AP status,test fail!"
