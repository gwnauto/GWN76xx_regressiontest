        ...
        try:
            ...
            while i<20:
                ...
                if MAC in element.text:
                    ...
                    element1 = self.driver.find_element_by_xpath(".//*[@id='clients_table']/div[%s]/div[3]"%i)
    ...
    def get_client_IP(self,mac):
        try:
            ...
            while i<20:
                ...
                if MAC in element.text:
                    print "choose mac:%s!"%mac
                    element1 = self.driver.find_element_by_xpath(".//*[@id='clients_table']/div[%s]/div[4]"%i)
                    result = element1.text
                    print result
                    return result
                i = i+1
    ...
    def get_client_time(self,mac):
        try:
            ...
            while i<20:
                ...
                if MAC in element.text:
                    print "choose mac:%s!"%mac
                    element1 = self.driver.find_element_by_xpath(".//*[@id='clients_table']/div[%s]/div[6]/div/div[2]"%i)
                    result = element1.text
                    print result
                    return result
                i = i+1
    ...
    def get_online_status(self,mac):
        try:
            ...
            while i<20:
                ...
                if MAC in element.text:
                    print "choose mac:%s!"%mac
                    element1 = self.driver.find_element_by_xpath(".//*[@id='clients_table']/div[%s]/div[6]/div//span"%i)
                    result = element1.text
                    print result
                    return result
                i = i+1
        ...
        try:
            ...
            while i<20:
                ...
                if MAC in element.text:
                    ...
                    self.driver.find_element_by_xpath(".//*[@id='clients_table']/div[%s]/div[13]/div/button[1]"%i).click()
        ...
        try:
            ...
            while i<20:
                ...
                if MAC in element.text:
                    ...
                    self.driver.find_element_by_xpath(".//*[@id='clients_table']/div[%s]/div[13]/div/button[2]"%i).click()
                    self.driver.implicitly_wait(10)
                    break
                i = i+1
            time.sleep(3)
    ...
    def get_AP_name(self,mac):
        try:
            ...
            while i<20:
                ...
                if MAC in element.text:
                    print "choose mac:%s!"%mac
                    element1 = self.driver.find_element_by_xpath(".//*[@id='clients_table']/div[%s]/div[10]/a"%i)
                    result = element1.text
                    print result
                    return result
                i = i+1
