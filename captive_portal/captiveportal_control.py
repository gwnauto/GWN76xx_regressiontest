...
class CPControl(PublicControl):
    ...
    def get_client_mac(self,n):
        try:
            element = self.driver.find_element_by_xpath(".//*[@id='clientslist']/fieldset/div/div[%s]/div[1]/div"%(n+1))
            MAC = element.text
            mac = MAC.lower()
            print mac
            return mac
    ...
    def get_client_ip(self,n):
        try:
            element = self.driver.find_element_by_xpath(".//*[@id='clientslist']/fieldset/div/div[%s]/div[2]/div"%(n+1))
            ip = element.text
            print ip
            return ip
        except Exception as e:
    ...
    def get_client_auth_status(self,n):
        try:
            element = self.driver.find_element_by_xpath(".//*[@id='clientslist']/fieldset/div/div[%s]/div[4]/div"%(n+1))
            status = element.text
            print status
            return status
        except Exception as e:
